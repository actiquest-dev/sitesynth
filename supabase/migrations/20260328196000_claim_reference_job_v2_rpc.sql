-- New RPC to avoid ambiguity issues with claim_reference_job
create or replace function claim_reference_job_v2(worker_id text)
returns table (
  job_id uuid,
  brief_id uuid,
  user_email text
...
begin
  ...
  returning rj.id as job_id, rj.brief_id as brief_id, rj.user_email as user_email;
end;
$$;

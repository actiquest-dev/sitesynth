<template>
  <button
    ...
    class="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-[#1f2937] font-semibold rounded-lg hover:bg-gray-100 focus:ring-2 focus:ring-[#0033ff]/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
  >
    <svg v-if="loading" class="animate-spin h-5 w-5 text-[#0033ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">

  ...
  >
    ...
    <div class="relative w-full max-w-[1248px] mx-auto px-6 py-10">
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <span class="text-xs text-[#999999]">Complex projects, SaaS & custom solutions</span>
      </div>
      ...
      <div v-if="submitted" class="border border-[#2a2a2a]" style="background: #161616;">
        ...
        <div class="px-10 py-8 max-w-3xl mx-auto w-full">
          ...
          <p class="text-sm text-[#999999] mb-8">Select a time that works for you and we'll review your project together.</p>
          ...
          <div class="mt-6 pt-5 border-t border-[#1f1f1f] flex items-center justify-between">
            <p class="text-xs text-[#999999]">You can also access your project status in the dashboard</p>
            <NuxtLink to="/cabinet"
        ...
        <div class="border border-[#2a2a2a]" style="background: #161616;">
          ...
          <div class="px-10 py-8 max-w-3xl mx-auto w-full">
            ...
            <div v-if="currentStep === 1">
              ...
              <p class="text-sm text-[#999999] mb-7">Complex projects that require a custom approach and dedicated team</p>
                ...
                <label v-for="service in services" :key="service.id" class="cursor-pointer group">
                  ...
                  <div :class="[
                    ...
                    <div class="flex items-start gap-3 mb-2">
                      ...
                      <span class="text-sm font-medium" :style="{ color: formData.service === service.id ? '#ffffff' : '#999999' }">
                        {{ service.label }}
                      </span>
                    ...
                    <p :class="[
                      ...
                      formData.service === service.id ? 'text-[#d4d4d4]' : 'text-[#999999]'
            ...
            <div v-if="currentStep === 2">
              ...
              <p class="text-sm text-[#999999] mb-7">The more detail you give, the better we can prepare for the call</p>
              <div class="space-y-4">
                <div>
                  ...
                  <p class="mt-1 text-[11px]" :class="formData.description.length >= 50 ? 'text-[#999999]' : 'text-[#8D35FF]/60'">
                    {{ formData.description.length }}/50 characters minimum
                  </p>
                </div>
                <div>
                  <label class="block text-[10px] uppercase tracking-widest text-[#999999] mb-1.5">Tech stack / integrations</label>
                ...
                <div>
                  <label class="block text-[10px] uppercase tracking-widest text-[#999999] mb-1.5">Target audience</label>
            ...
            <div v-if="currentStep === 3">
              ...
              <p class="text-sm text-[#999999] mb-7">This helps us assign the right team and plan accordingly</p>
              <div class="space-y-5">
                <div>
                  <label class="block text-[10px] uppercase tracking-widest text-[#999999] mb-2">Approximate budget *</label>
                  <div class="grid grid-cols-2 gap-2">
                    <label v-for="range in budgetRanges" :key="range.value" class="cursor-pointer">
                      ...
                      <div :class="[
                        ...
                        <p class="text-[11px] text-[#999999] mt-0.5">{{ range.note }}</p>
                      </div>
                    </label>
                  </div>
                </div>
            ...
            <div v-if="currentStep === 4">
              ...
              <p class="text-sm text-[#999999] mb-7">Select everything relevant to your project</p>
              <div class="space-y-1.5">
                <label v-for="feature in features" :key="feature.id" :class="[
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm transition-colors" :class="isFeatureSelected(feature.id) ? 'text-white' : 'text-[#999999]'">{{ feature.label }}</p>
                    <p class="text-xs mt-0.5 transition-colors" :class="isFeatureSelected(feature.id) ? 'text-[#d4d4d4]' : 'text-[#999999]'">{{ feature.description }}</p>
                  </div>
                </label>
              </div>
              <div class="mt-5">
                <label class="block text-[10px] uppercase tracking-widest text-[#999999] mb-1.5">Custom requirements</label>
            ...
            <div v-if="currentStep === 5">
              ...
              <p class="text-sm text-[#999999] mb-7">Our team will review your brief before the call</p>
              <div class="space-y-4">
                ...
                <div>
                  <label class="block text-[10px] uppercase tracking-widest text-[#999999] mb-1.5">Role / Position</label>

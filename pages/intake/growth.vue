  ...
  >
    ...
    <div class="relative w-full max-w-[1248px] mx-auto px-6 py-10">
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <span class="text-xs text-[#999999]">Multi-page websites & integrations</span>
      </div>
      ...
      <div class="border border-[#2a2a2a]" style="background: #161616;">
        ...
        <div class="px-10 py-8 max-w-3xl mx-auto w-full">
          ...
          <div v-if="currentStep === 1">
            ...
            <p class="text-sm text-[#999999] mb-7">Multi-page projects with advanced features and integrations</p>
          ...
          <div v-if="currentStep === 2">
            ...
            <p class="text-sm text-[#999999] mb-7">Help us understand the size and complexity of your project</p>
            <div class="space-y-5">
              <div>
              ...
              <div v-if="formData.complexity === 'complex'">
                <label class="block text-[10px] uppercase tracking-widest text-[#999999] mb-2">Additional pages beyond 5</label>
                <div class="flex items-center gap-3">
                  <div class="relative flex-1">
                    <input
                      v-model.number="formData.extraPages"
                      type="number" min="0" placeholder="0"
                      class="w-full border px-4 py-2.5 text-sm text-white placeholder:text-[#999999] focus:outline-none transition-colors"
                      style="background: #1a1a1a; border-color: #2a2a2a;"
                      @focus="e => e.target.style.borderColor = '#8D35FF'"
                      @blur="e => { if (e.target.value < 0) formData.extraPages = 0; e.target.style.borderColor = '#2a2a2a' }"
                    />
                  </div>
                  <div class="text-sm text-[#999999] whitespace-nowrap">
                    × €85 =
                    <span class="text-[#8D35FF] font-medium">€{{ (Math.max(0, formData.extraPages || 0) * 85) }}</span>
                  </div>
                </div>
                <p class="text-xs text-[#999999] mt-1.5">Each additional page beyond 5 is billed at €85</p>
              </div>
            </div>
          </div>
          ...
          <div v-if="currentStep === 3">
            ...
            <p class="text-sm text-[#999999] mb-7">Included items are free. Add-ons are billed once.</p>
            <div class="space-y-1.5">
              <label v-for="feature in features" :key="feature.id" :class="[
                ...
                <span class="text-xs font-medium" :class="isFeatureSelected(feature.id) ? 'text-white' : (feature.price === 'Included' ? 'text-[#999999]' : 'text-[#8D35FF]')">{{ feature.price }}</span>
              </label>
            </div>
          ...
          <div v-if="currentStep === 4">
            ...
            <p class="text-sm text-[#999999] mb-7">We'll send your invoice and project updates here</p>
            <div class="space-y-4">
          ...
          <div v-if="currentStep === 5">
            ...
            <p class="text-sm text-[#999999] mb-7">Review your project before proceeding to payment</p>

            <div class="space-y-3">
              <div class="border border-[#2a2a2a]" style="background: #1a1a1a;">
                <div class="px-4 py-2.5 border-b border-[#2a2a2a]">
                  <p class="text-[10px] uppercase tracking-widest text-[#999999]">Project</p>
                </div>
                <div class="px-4 py-3 space-y-2">
                  <div class="flex justify-between text-sm">
                    <span class="text-[#999999]">Service</span>
                    <span class="text-white capitalize">{{ services.find(s => s.id === formData.service)?.label || '—' }}</span>
                  </div>
                  <div class="flex justify-between text-sm">
                    <span class="text-[#999999]">Complexity</span>

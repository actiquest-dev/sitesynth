    ...
    <template #content>
      <div class="text-[#161616]">
        ...
        <div class="mb-12">
          ...
          <p class="mb-4">
            Send us your CV, a short cover note, and a few examples of your work
            — campaigns, writing samples, landing pages, or case studies.
          </p>
    ...
    },
    {
      ...
      children: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Marketing Manager", item: `${siteUrl}/careers/marketing-manager` },
        ],
      }),
    },
  ],

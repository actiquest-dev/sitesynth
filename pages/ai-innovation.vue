<template>
  ...
  <TwoColumnSection
    ...
    :leftContent="{
      ...
      textElements: [
        { tag: 'h4', content: 'Knowledge Memory Layer' },
        {
          tag: 'p',
          content:
            'Membria builds a decentralized memory and reasoning layer for Tiny Language Models, enabling AI to learn, adapt, and grow smarter over time.',
        },
      ],
      link: {
    ...
    :rightContent="{
      image: {
        src: '/assets/new-assets/solutions-page/solutions/ai-infused-innovation-and-rd/cta/MembriaImage.png-page/solutions/ai-infused-innovation-and-rd/cta/membria-image.png',

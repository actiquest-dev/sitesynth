...
<template>
    ...
    <OneColumnImage glowEffect="GlowRed" centerImg="/assets/new-assets/products-page/product/score-synth/how-works/UI'sOverPattern.png" centerImgAlt="ScoreSynth UI Interface" />

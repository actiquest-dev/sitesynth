...
<template>
    ...
    <TwoColumnsDesign glowEffect="GlowRed" sectionBgColor="bg-[#161616]" leftColumnBgColor="bg-[#161616]"
        ...
        <template #left>
            <div class="px-6 py-24 md:pl-[10rem] md:pr-6 md:border-r border-[#636363] bg-[#161616]">
                <h2 class="text-white text-3xl sm:text-4xl mb-6"> From Musician to Builder.</h2>
                <p class="text-[#999999] text-normal font-light mb-4">Before founding SiteSynth, I was a musician.</p><p class="text-[#999999]"> I studied at the conservatory, spent years immersed in orchestras, and worked closely with composers, arrangers, and ensembles of all shapes and sizes. And while I eventually moved into technology and development, my passion for music never left.</p>
                <h3 class="text-white text-2xl mt-4 mb-4">With SynthScore, we’re removing that barrier.
                </h3>
    ...
    <ProcessSection accentColor="text-[#AA3733]" imageSrc="/assets/why-1.png" imageClass="px-10 py-10" imageAlt="Synth"
        :images="[
            { src: '/assets/new-assets/products-page/product/score-synth/accordion/upload-your-source.png', alt: 'Discover - Business Goals Analysis' },
            { src: '/assets/new-assets/products-page/product/score-synth/accordion/ai-analyzes-separates-the-music.png', alt: 'Define - Challenge Clarification' },
            { src: '/assets/new-assets/products-page/product/score-synth/accordion/transcription-into-digital-notes.png', alt: 'Design - Systems and Flows' },
            { src: '/assets/new-assets/products-page/product/score-synth/accordion/orchestration-with-intelligence.png', alt: 'Deliver - Design Implementation' },
            { src: '/assets/new-assets/products-page/product/score-synth/accordion/ready-out-put.png', alt: 'Deliver - Design Implementation' }
        ]" :sections="[

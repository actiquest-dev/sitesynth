<template>
  ...
  <TwoColumnsWithImages
    ...
    rightP="We design with engineers in mind — ensuring everything is structured, inspectable, and ready to build. 
      ...
      Using Figma’s Dev Mode, we bridge the gap between design and development with clear tokens, component logic, and handoff details — no extra tools, no ambiguity."
